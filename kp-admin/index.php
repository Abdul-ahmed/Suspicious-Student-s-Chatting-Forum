...
<head>
    ...
    <title>Admin - KWARA STATE POLYTECHNIC STUDENTS' FORUM</title>
    <!-- Font Awesome -->
      ...
      <div class="d-flex justify-content-center h-100">
        <div class="user_card">
          ...
          <div class="d-flex justify-content-center form_container">
            <form class="signin-admin" action="../includes/signin.admin.inc.php" id="login-form" method="POST" novalidate>
            	<?php
              	...
              	<div class="form-group">
	                <div class="input-group mb-3">
	                  ...
	                  <input type="text" name="uid" class="form-control input_user" placeholder="Username" autofocus>
	                </div>
              	</div>
              	<div class="form-group">
