    ...
    <div class="page-wrapper chiller-theme toggled">
        ...
        <main class="page-content">
            <div class="container-fluid">
                ...
                <h1><strong>Disabled Students</strong></h1>
                <hr>
                <h5><strong>All Disabled Students</strong></h5>
                <hr>
                <div class="row">
                    <div class="col-xs-12 col-sm-12 col-md-12 col-lg-12">
                        <div class="table-responsive">
                            <table id="mytable" class="table table-bordered table-striped text-center">
                                ...
                                <?php
                                    $sql = "SELECT id, firstname, lastname, othername, matric FROM disabletable ORDER BY id asc;";
                                    $query = mysqli_query($myConn, $sql);
                                    $resultCheck = mysqli_num_rows($query);
                                    ...
                                    if ($resultCheck > 0) {
                                        while ($row = mysqli_fetch_assoc($query)) {
                                            ...
                                            echo "<tbody><tr><td><input type='checkbox' class='checkthis' /></td><td>".$row['firstname']."</td><td>".$row['lastname']."</td><td>".$row['othername']."</td><td>".$row['matric']."</td><td><p class='edit-button' data-placement='top' data-toggle='tooltip' title='Disable'>
                                                <a href='../includes/enable.student.inc.php?ena=".$row['id']."'>
                                                <button class='btn btn-success btn-sm' data-title='Edit' data-toggle='modal' data-target='' id='btn-confirm'>
