...
<head>
	<meta charset="utf-8">
  	...
  	<title>Sign In - KWARA STATE POLYTECHNIC STUDENTS' FORUM</title>
  	<!-- Font Awesome -->
		...
		<div class="d-flex justify-content-center h-100">
			<div class="user_card">
				...
				<div class="d-flex justify-content-center form_container">
					<form class="signin-student" action="includes/signin.students.inc.php" id="login-form" method="POST" novalidate>
						<?php
          				...
          				<div class="form-group">
							<div class="input-group mb-3">
								...
								<input type="text" name="uid" class="form-control input_user" placeholder="Matric No" autofocus>
							</div>
						</div>
						<div class="form-group">
